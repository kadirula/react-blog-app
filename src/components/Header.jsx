            ...
            <div className="container mx-auto h-16 flex items-center justify-between">
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm flex items-center">
                        ...
                        <button type='submit' className='bg-indigo-700 text-white px-3 rounded-tr-lg rounded-br-lg h-9'>Ara</button>
                    </div>
                </form>
                <ul className='flex items-center'>
                    ...
                    <li className='mx-4'>
                        <Link to="/" className='font-bold hover:text-indigo-600 transition-colors'>Yayınladığım Yazılar</Link>
                    </li>
                    <li className='mx-4'>
