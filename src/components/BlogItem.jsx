...
const BlogItem = () => {
    return (
        <div>
            <div className='blog mx-3 mb-5 shadow-xl rounded-lg overflow-hidden relative'>
                <div className='overflow-hidden max-h-64 relative'>
                    ...
                    <Link to='/author-blog' className='absolute top-0 right-0 bg-indigo-500 text-white px-5 font-bold py-1 z-10'>Yazar Adı</Link>
                    <Link to='/category-blog' className='absolute bottom-0 left-0 bg-indigo-500 text-white px-5 font-bold py-1 z-10'>Kategori</Link>
                </div>
